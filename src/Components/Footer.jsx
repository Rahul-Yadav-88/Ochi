...
const Footer = () => {
    return (
        <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20 font-[Founders Gortexk] '>
            <div className='w-1/2 h-full flex flex-col justify-between '>

                <div className='heading'>
                    <h1 className='text-[8vw] leading-none font-semibold -mb-6'>EYE-</h1>
                    <h1 className='text-[8vw] leading-none font-semibold -mb-8'>OPENING</h1>
                </div>
            ...
            <div className='w-1/2'>
            <h1 className='text-[5vw] leading-none font-semibold -mb-6'>PRESENTATIONS</h1>
            <div className='font-[Neue Montreal] mt-20 '>
                <a className='block hover:text-red-800 text-xl font-light' href='#'>Facebook</a>
                <a className='block hover:text-red-800 text-xl font-light' href='#'>Instagram</a>
                <a className='block hover:text-red-800 text-xl font-light' href='#'>Twitter</a>
            </div>
                </div>
        </div>
    )
